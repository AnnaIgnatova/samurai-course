...
export const getUserDataThunk =
  (userId: string) => async (dispatch: Dispatch<ProfileReducerPayloadType>) => {
...
export const updateStatusDataThunk =
  (text: string) => async (dispatch: Dispatch<ProfileReducerPayloadType>) => {
...
export const saveProfilePhotoThunk =
  (file: File) => async (dispatch: Dispatch<ProfileReducerPayloadType>) => {
